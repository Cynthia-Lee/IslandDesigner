...
public class IslandNetworkAndroid {
    // holds the graph
     ...
     */
    public static IslandNetworkAndroid loadFromFileAndroid(String url) { // loads the file from the given URL location
        // DataSource ds = DataSource.connectXML(url);
        // ds.load();
        // HashMap<String,Node> cities = new HashMap<String,Node>();
        IslandNetworkAndroid network = new IslandNetworkAndroid();
